    ...
    <div className="min-h-screen bg-paper-2">
      ...
      <div className="max-w-sm mx-auto px-4 py-6 space-y-4 animate-slide-up">
        ...
        <div className="border-l-2 border-line pl-3 py-1">
          ...
          <p className="text-xs text-ink-3 mt-1.5 opacity-70">
            {tl
              ? 'Gawa ng LegitCheck PH — community tool. Hindi opisyal na finding ng gobyerno o law enforcement.'
              : 'Generated by LegitCheck PH — a community tool, not a government or law-enforcement finding.'}
          </p>
        </div>
